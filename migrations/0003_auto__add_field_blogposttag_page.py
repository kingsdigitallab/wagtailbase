...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogPostTag.page'
        db.add_column(u'wagtailbase_blogposttag', 'page',
                      self.gf('modelcluster.fields.ParentalKey')(default=0, related_name='tagged_items', to=orm['wagtailbase.BlogPost']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogPostTag.page'
        db.delete_column(u'wagtailbase_blogposttag', 'page_id')
    ...
    models = {
        ...
        u'wagtailbase.blogposttag': {
            ...
            'content_object': ('modelcluster.fields.ParentalKey', [], {'related_name': "'tagged_items_old'", 'to': u"orm['wagtailbase.BlogPost']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'tagged_items'", 'to': u"orm['wagtailbase.BlogPost']"}),
