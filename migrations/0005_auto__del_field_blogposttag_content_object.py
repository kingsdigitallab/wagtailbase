...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BlogPostTag.content_object'
        db.delete_column(u'wagtailbase_blogposttag', 'content_object_id')


    def backwards(self, orm):
        # Adding field 'BlogPostTag.content_object'
        db.add_column(u'wagtailbase_blogposttag', 'content_object',
                      self.gf('modelcluster.fields.ParentalKey')(default=0, related_name='tagged_items_old', to=orm['wagtailbase.BlogPost']),
                      keep_default=False)
